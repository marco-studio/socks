...
const IndexPage = ({ data }) => {
  ...
  return (
    <Layout>
      <SEO title="Stiff Socks" description={siteDescription} img={logo} />
      ...
      <div>
        ...
        >
          <div className="md:ml-8 md:mt-3 lg:ml-12">
            ...
            <div className="text-sm mt-1 md:text-base text-gray-100">
              By Michael Blaustein &amp; Trevor Wallace
            </div>
            <ul className="md:flex mt-6 hidden text-gray-100">
              {/* <li className="mr-8">
                <a href="https://www.youtube.com/channel/UCc35WvHmQjLE8NN4Y_ITmUQ">
                  <img src={youtube} alt="youtube logo" />
                </a>
              </li> */}
              <li className="mr-8">
                <a href="https://twitter.com/stiff_socks?lang=en">
                  <svg
                    width="24"
                    height="24"
                    fill="none"
              ...
              <li className="mr-8">
                <a href="https://www.instagram.com/stiffsockspod/">
                  <svg
                    width="24"
                    height="24"
                    fill="none"
        ...
        <div className="text-center p-8 max-w-md md:max-w-lg m-auto mt-16 lg:max-w-xl lgx:max-w-2xl lgx:mt-24">
          ...
          <div className="mt-3 text-gray-700 leading-relaxed md:text-xl">
            Stand up comedians Trevor Wallace and Michael Blaustein go do weird
            stuff, and then talk about how weird the weird stuff was. With their
            irrelevant charm they will tackle tough issues such as, what’s it
            like going to a museum on Adderall or if you don’t cum for a week
            will you die?
          </div>
          <div className="mt-3 text-gray-700 leading-relaxed md:text-xl">
            Stiff Socks Podcast is like the basement of your friends house with
            the super cool parents that let you chill and smoke weed down
            there... so come kick it in the Stiff Socks basement. Be part of the
            fun. Be part of The Sock Squad!
          </div>
        ...
        <div className="w-full bg-gray-100 text-center pb-8 md:pb-16 mt-16 lgx:mt-24">
          <div className="max-w-lg md:max-w-xl m-auto lgx:max-w-2xl">
            ...
            <div className="font-medium text-gray-700 leading-relaxed pl-8 pr-8 mt-6 md:text-xl">
              This includes 4 extra episodes a month, LIVE streamed shows with
              the chance to ask questions and other perks
            </div>
            <div className="flex justify-center md:mt-10">
              <a
                href="https://www.patreon.com/stiffsockspod"
